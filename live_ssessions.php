...
$sql1 = mysqli_query($conn, "SELECT * FROM yoga_db.live_sessions where live_sessions.class_id = " . $id);
$i = 0;
?>
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown active" aria-current="page">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" aria-current="page" href="/classes.php">Recoreded</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container">
        ...
        <div style="margin-top: 15px;">
            <h3 style="text-align: center">Session Details</h3>
        </div>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($sql1)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="<?php echo $link ?>" class="btn btn-info">Join</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
